...
## Status
- [x] config.py updated (domain=candidptx_pneumothorax_rib_tube_seg, s3_prefix=M-102_Candid-PTX/raw/, fps=3)
...
## Task prompt
This chest X-ray (Candid-PTX). Segment pneumothorax (red), rib fractures (green), and chest tubes (blue) simultaneously.
